package com.gsacorduvs.po.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.gsacorduvs.po.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.gsacorduvs.po.repository.UserRepository.USERS_BY_EMAIL_CACHE);
